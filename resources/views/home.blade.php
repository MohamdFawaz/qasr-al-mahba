...
<!--====================================================================
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="section-title wow fadeInUp" data-wow-duration="2s">
                        <h2>{{trans('web.home.our_trusted')}}<br> {{trans('web.home.partners')}}.</h2>
                    </div>
                </div>
                <div class="col-xl-8">
                    <div class="partner-wrap">
                        <div class="partner-item">
                            <img src="https://source.unsplash.com/random/120x109" alt="Partner Image">
                        </div>
                        <div class="partner-item">
                            <img src="https://source.unsplash.com/random/120x109" alt="Partner Image">
                        </div>
    ...
    <footer class="footer-section bg-black">
        ...
        <div class="col-9 pt-150 rpt-100">
            <div class="row">
